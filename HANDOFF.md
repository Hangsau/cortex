...
## CSCS 題庫重寫：ch01–ch09 完成，出題／審查／重出全改走直呼 API（2026-09-17）
...
20 題落在 20 個不同 item，沒有同 item 兩題）。ch10–ch24 尚未開始，照章號串行，
...
ch10 → ch24 照章號串行，每章「`cscs_quiz_direct.py` 出題 → 過閘 → 人工逐題查證 →
