...
已驗Hugo170頁、887條連結、讀本瀏覽器97/97、本批手機大字／69錨點／跨書落點／兩圖／鍵盤41步／無JavaScript119/119、原頁服務18/18；原PNG與手機圖解已目視。來源／決策／驗收見 `research/book-readers-2026-09-06/trunk-expansion/`。目前待推送實作與核對完整SHA部署、正式HTML及CSS／JS，再更新此快照。原書與來源包留本機。
