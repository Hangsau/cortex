...
原書733–750主要段落已核閱，目視739／747／749／750 PNG；正文明示質心動能及膝摘要方向問題，保留EMG／力矩／功率的層級，髕股段補2024指引摘要的介入方向。Hugo172頁、1,361連結、本章36/36、既有讀本97/97、原頁服務18/18均通過，目視手機兩色與桌面。詳見`research/book-readers-2026-09-06/running-expansion/RUN.md`與`validation.json`。發布證據待本批部署後回填。
