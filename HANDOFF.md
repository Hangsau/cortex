...
使用者明確准許較便宜模型初譯；兩個 `gpt-5.6-luna` 子代理各完成一份分段稿與修訂，主代理核對、修正力學條件及整合。第 1 章由 4 節／922 中文字加深為 17 節／8,480 中文字，保留四個舊錨點；全讀本目前 146 節、31,879 中文字，仍是詳解／導讀，未宣稱全文逐句翻譯。來源與 513 條 HTML 連結通過，讀本瀏覽器 97/97，加深章 320 px／22px 字級、17 節、舊錨點與收合目次另驗。工作 checkpoint：`research/book-readers-2026-09-06/ch01-expansion/RUN.md`；下一個內容批次從第 2–4 章基礎概念加深開始，不重新排版全站。
