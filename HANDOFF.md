...
已驗Hugo170頁、1139連結、既有讀本97/97、原頁服務18/18、本批手機大字／80錨點／跨書實際點擊／41步鍵盤／兩尺寸兩色三狀態／無JS113/113；手機正文、完整任務表與三種分配圖已目視。來源／語意決策與證據見`research/book-readers-2026-09-06/knee-expansion/{RUN.md,content-counts.json,browser-checks.json}`。發布的完整SHA、CI及正式站比對待本次部署後回填。
