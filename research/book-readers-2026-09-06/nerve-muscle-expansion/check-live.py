"""Compare deployed peripheral nerve and skeletal muscle readers with the accepted local build."""
import argparse
...
def main():
    ...
    for chapter in ['basic-biomechanics/ch05', 'basic-biomechanics/ch06']:
        ...
        original = {'basic-biomechanics/ch05': ['nerve-structure', 'nerve-tension', 'compression', 'nerve-roots'], 'basic-biomechanics/ch06': ['muscle-scales', 'length', 'architecture', 'velocity-time']}[chapter]
