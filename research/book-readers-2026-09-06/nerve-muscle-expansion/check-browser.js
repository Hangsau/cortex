...
const shots = path.resolve(root, '../../tmp/nerve-muscle-expansion/screenshots');
const chapters = ['basic-biomechanics/ch05', 'basic-biomechanics/ch06'];
const originals = [['nerve-structure', 'nerve-tension', 'compression', 'nerve-roots'], ['muscle-scales', 'length', 'architecture', 'velocity-time']];
