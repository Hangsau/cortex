...
const shots = path.resolve(root, '../../tmp/fixation-arthroplasty-expansion/screenshots');
const chapters = ['basic-biomechanics/ch15', 'basic-biomechanics/ch16'];
const originals = [['fracture-motion', 'local-strain', 'construct', 'sharing'], ['implant-loads', 'model-assumptions', 'stress-shielding', 'wear']];
