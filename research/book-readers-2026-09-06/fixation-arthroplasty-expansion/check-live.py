"""Compare deployed fracture fixation and arthroplasty readers with the accepted local build."""
import argparse
...
def main():
    ...
    for chapter in ['basic-biomechanics/ch15', 'basic-biomechanics/ch16']:
        ...
        original = {'basic-biomechanics/ch15': ['fracture-motion', 'local-strain', 'construct', 'sharing'], 'basic-biomechanics/ch16': ['implant-loads', 'model-assumptions', 'stress-shielding', 'wear']}[chapter]
