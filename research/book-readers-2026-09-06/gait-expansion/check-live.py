"""Compare deployed gait readers with the accepted local build."""
import argparse
...
def main():
    ...
    for chapter in ['kinesiology/ch15', 'basic-biomechanics/ch17']:
        ...
        original = (['cycle', 'weight-acceptance', 'swing', 'gait-measurement']
                    if chapter == 'kinesiology/ch15' else
                    ['gait-events', 'measurements', 'moments', 'power'])
