...
2026-09-09 頸椎批更新：Nordin第11章由4節／983字加深為36節／7,276中文字，補Neumann第9、10章的精確往返連結；原92個錨點保留。新增影像放大率互動圖，以固定2.70mm及30%倍率示範影像3.51mm。全讀本現為491節／127,184中文字；肌動學第1–10章與Nordin第10–14章已加深，仍是逐章詳解／導讀，非全書逐句翻譯。來源、矛盾處理、語意範圍與84/84本批瀏覽器驗收見 `cervical-expansion/RUN.md`；前批脊柱肌肉／腰椎結果保留於 `trunk-expansion/RUN.md`，其他前批紀錄仍在各expansion目錄。下方133節／約2.4萬字及初次部署紀錄保留為2026-09-06初版快照。
