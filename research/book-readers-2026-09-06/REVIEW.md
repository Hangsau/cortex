...
2026-09-07 更新：首頁入口、肩部與肘部批次已完成部署。本批續加深 Neumann 第 7 章手腕 28 節／6,723 字，以及 Nordin 第 14 章腕與手 26 節／5,921 字，新增腕部傾斜關節面的向量分解與手指肌腱滑車受力互動圖。全讀本現為 318 節／89,504 中文字，肌動學第 1–7 章與 Nordin 第 12–14 章已加深，仍為逐章導讀／詳解。來源核對及驗收見 `ch01-expansion/RUN.md`、`ch02-04-expansion/RUN.md`、`shoulder-expansion/RUN.md`、`elbow-expansion/RUN.md`、`wrist-expansion/RUN.md`；下方 133 節／約 2.4 萬字及初次部署紀錄保留為 2026-09-06 初版快照。
