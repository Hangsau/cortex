...
2026-09-09 髖關節批更新：Neumann第12章由4節／744字加深為51節／10,180中文字；Nordin第8章由4節／682字加深為26節／5,081字，保留原八個錨點。涵蓋骨關節、骨盆相對運動、肌肉分工、雙腳／單腳承重、拐杖與攜物，以及模型和植入物量測的差別；新增拐杖力矩互動圖。全讀本現為596節／148,440中文字；肌動學第1–12章與Nordin第8、10–14章已加深，仍為逐章詳解／導讀。來源、兩冊差異與驗收在 `hip-expansion/RUN.md`；前批咀嚼與呼吸紀錄保留於 `mastication-ventilation-expansion/`。下方133節／約2.4萬字及初次部署紀錄保留為2026-09-06初版快照。
