...
2026-09-07 更新：首頁漏接入口已修復並部署，首要捷徑與兩冊常駐連結已在線上核對；第 1 章另完成 17 節／8,480 中文字的加深稿，全讀本現為 146 節／31,879 中文字。後續驗收與模型分工記於 `ch01-expansion/RUN.md`；下方 133 節／約 2.4 萬字及初次部署紀錄保留為 2026-09-06 初版快照。
