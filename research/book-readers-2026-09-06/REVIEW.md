...
2026-09-07 更新：首頁入口已修復並部署，肩部批次已完成。本批續加深 Neumann 第 6 章肘與前臂 31 節／7,386 字，以及 Nordin 第 13 章 19 節／4,752 字，新增骨間膜壓縮／牽引圖解及可調重量的肘部受力算例。全讀本現為 272 節／78,212 中文字，肌動學第 1–6 章與 Nordin 第 12–13 章已加深，仍為逐章導讀／詳解。來源核對及驗收見 `ch01-expansion/RUN.md`、`ch02-04-expansion/RUN.md`、`shoulder-expansion/RUN.md`、`elbow-expansion/RUN.md`；下方 133 節／約 2.4 萬字及初次部署紀錄保留為 2026-09-06 初版快照。
