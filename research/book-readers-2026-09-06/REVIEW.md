...
2026-09-13 踝足批更新：Neumann第14章加深為51節／10,069中文字，Nordin第9章為31節／6,238字，保留原八個錨點。涵蓋踝穴、距下與中足相對運動、足弓、筋膜、肌肉、內部負荷與步態；新增編者平行三力互動圖，分清兩書原踮腳模型的配置與限制。全讀本現為742節／178,277中文字；肌動學第1–14章與Nordin第7–14章已加深，仍為逐章詳解／導讀。來源、兩冊差異及驗收在 `ankle-expansion/RUN.md`；前批膝關節紀錄保留於 `knee-expansion/`。下方133節／約2.4萬字及初次部署紀錄保留為2026-09-06初版快照。
