...
2026-09-07 更新：首頁漏接入口已修復並部署，第 1 章完成 17 節／8,480 中文字的加深稿；後續第 2–4 章再加深為 54 節／23,128 中文字，新增兩張中文力學圖。全讀本現為 188 節／52,259 中文字，仍為逐章導讀／詳解。後續驗收與模型分工記於 `ch01-expansion/RUN.md`、`ch02-04-expansion/RUN.md`；下方 133 節／約 2.4 萬字及初次部署紀錄保留為 2026-09-06 初版快照。
