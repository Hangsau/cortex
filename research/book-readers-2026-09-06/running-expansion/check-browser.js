...
const shots = path.resolve(root, '../../tmp/book-translation-running/screenshots');
const chapters = ['kinesiology/ch16'];
const originals = [['support-flight', 'foot-strike', 'muscle-timing', 'energy']];
const reference = ['kinesiology/ch15'];
