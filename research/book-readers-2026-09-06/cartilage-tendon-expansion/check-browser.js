...
const shots = path.resolve(root, '../../tmp/cartilage-tendon-expansion/screenshots');
const chapters = ['basic-biomechanics/ch03', 'basic-biomechanics/ch04'];
const originals = [['matrix', 'biphasic', 'fluid-flow', 'lubrication'], ['roles', 'load-elongation', 'time-tests', 'whole-structure']];
