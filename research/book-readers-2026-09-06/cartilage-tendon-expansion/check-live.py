"""Compare deployed cartilage and tendon readers with the accepted local build."""
import argparse
...
def main():
    ...
    for chapter in ['basic-biomechanics/ch03', 'basic-biomechanics/ch04']:
        ...
        original = {'basic-biomechanics/ch03': ['matrix', 'biphasic', 'fluid-flow', 'lubrication'], 'basic-biomechanics/ch04': ['roles', 'load-elongation', 'time-tests', 'whole-structure']}[chapter]
