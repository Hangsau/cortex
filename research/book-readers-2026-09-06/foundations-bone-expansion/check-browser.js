...
const shots = path.resolve(root, '../../tmp/foundations-bone-expansion/screenshots');
const chapters = ['basic-biomechanics/ch01', 'basic-biomechanics/ch02'];
const originals = [['force-description', 'free-body', 'stress-strain', 'time-dependent'], ['bone-architecture', 'direction-geometry', 'loading-history', 'remodeling']];
const reference = ['kinesiology/ch04', 'basic-biomechanics/ch07'];
