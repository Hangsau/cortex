"""Compare deployed foundations and bone readers with the accepted local build."""
import argparse
...
def main():
    ...
    for chapter in ['basic-biomechanics/ch01', 'basic-biomechanics/ch02']:
        ...
        original = {'basic-biomechanics/ch01': ['force-description', 'free-body', 'stress-strain', 'time-dependent'], 'basic-biomechanics/ch02': ['bone-architecture', 'direction-geometry', 'loading-history', 'remodeling']}[chapter]
